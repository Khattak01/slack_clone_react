...
const Login = () => {
    const [,dispatch] = useStateValue()//here the state is not needed
    ...
    return (
        <div className="login">
            {showPopup ? <Popup closeClicked={popupCloseHandler} /> : null}
            <div className="login__container">
                ...
                />
                <h1>Sign in to Slack-Clone <br /> @khattak01</h1>
                <p>Email : mskhattak.ncs@gmail.com</p>
